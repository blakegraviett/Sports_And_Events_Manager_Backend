    ...
    case 'payment_intent.succeeded':
      {
        ...
        await sendEmail({
          ...
          html: `Hi,<br><br>You have successfully purchased a ticket.<br><br>Thank you for your purchase.<br><br>Regards,<br><br>Team Sportal.<br><br> <pre style="width:250px">${qrCode}</pre>`,
        })
      }
